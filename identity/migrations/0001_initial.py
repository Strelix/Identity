    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('DEV', 'Developer'), ('STAFF', 'Staff'), ('USER', 'User'), ('TESTER', 'Tester')], default='USER', max_length=10)),
                ...
                ('logged_in_as_team', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='identity.organization')),
            ...
            managers=[
                ('objects', identity.models.CustomUserManager()),
            ],
        ),
        migrations.AddField(
            model_name='organization',
            name='leader',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teams_leader_of', to='identity.user'),
        ),
        migrations.AddField(
            model_name='organization',
            name='members',
            field=models.ManyToManyField(related_name='teams_joined', to='identity.user'),
        ),
    ]
